function printSPPD() {
    ...
    const url = `print-layout.html?jarak=${jarak}&nominalJarak=${nominalJarak}&durasi=${durasi}&nominalDurasi=${nominalDurasi}&snack=${snack}&nominalSnack=${nominalSnack}&makan=${makan}&nominalMakan=${nominalMakan}&lembur=${lembur}&nominalLembur=${nominalLembur}&menginap=${menginap}&nominalMenginap=${nominalMenginap}&total=${total}&totalTerbilang=${totalTerbilang}&catatan=${encodeURIComponent(catatan)}&keteranganTambahan=${encodeURIComponent(keteranganTambahan)}`;
